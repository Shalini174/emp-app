      ...
      *--- REPORT FORMATTING STRUCTURES ---
       ...
       2100-CALCULATE-PAYROLL.
           COMPUTE WS-GROSS-PAY ROUNDED =
               ...
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW COMPUTING WS-GROSS-PAY'
           ...
           COMPUTE WS-TAX-AMOUNT ROUNDED =
               ...
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW COMPUTING WS-TAX-AMOUNT'
           ...
           SUBTRACT WS-TAX-AMOUNT FROM WS-GROSS-PAY
               GIVING WS-NET-PAY
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW COMPUTING WS-NET-PAY'
                   MOVE ZERO TO WS-NET-PAY
           END-SUBTRACT

           ADD WS-GROSS-PAY    TO WS-TOTAL-GROSS-PAY
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW ADDING TO WS-TOTAL-GROSS-PAY'
                   MOVE ZERO TO WS-TOTAL-GROSS-PAY
           END-ADD
           ADD WS-TAX-AMOUNT   TO WS-TOTAL-TAX-DEDUCTED
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW ADDING TO WS-TOTAL-TAX-DEDUCTED'
                   MOVE ZERO TO WS-TOTAL-TAX-DEDUCTED
           END-ADD
           ADD WS-NET-PAY      TO WS-TOTAL-NET-PAY
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW ADDING TO WS-TOTAL-NET-PAY'
                   MOVE ZERO TO WS-TOTAL-NET-PAY
           END-ADD.

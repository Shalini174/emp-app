      ...
      *--- REPORT FORMATTING STRUCTURES ---
       ...
       2000-PROCESS-FILE.
           IF STATUS-ACTIVE
               ...
               ADD 1 TO WS-TOTAL-EMPLOYEES
                   ON SIZE ERROR
                       DISPLAY 'OVERFLOW: WS-TOTAL-EMPLOYEES'
               END-ADD
           END-IF
           PERFORM 1100-READ-EMP-FILE.
       ...
       2100-CALCULATE-PAYROLL.
           ...
           COMPUTE WS-TAX-AMOUNT ROUNDED =
               ...
               ON SIZE ERROR
                   DISPLAY 'OVERFLOW: WS-TAX-AMOUNT'
